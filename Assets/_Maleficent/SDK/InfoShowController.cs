...
public class InfoShowController : MonoBehaviour {
	public GameObject ChangeShow,Shopshow,Storeshow,Liveshow,Giftshow;
	int count=0;
	public bool showui;
	...
	{
		/*
		ChangeShow.GetComponent<BoxCollider> ().enabled = bEnable;
...
//		Giftshow.GetComponent<BoxCollider> ().enabled = bEnable;
		*/
		ColliderManager.ToggleCollider (bEnable);
