...
public class Match3BoardGameLogic : AbstractBoardGameLogic
{
    ...
    {
        Logic.EventCenter.Log(LOG_LEVEL.WARN, "Match3BoardGameLogic --> OnLoseChecked-->");
    ...
    {
        Logic.EventCenter.Log(LOG_LEVEL.WARN, "Match3BoardGameLogic --> OnWinChecked-->");
        loseConditions.Pause(true);
    ...
    protected IEnumerator CheckStableBoard()
    {
        ...
        if (!IsBoardStable)
        {
            ...
            {
                Logic.EventCenter.Log(LOG_LEVEL.WARN, "...CheckStableBoard!!->" + OnStableBoard.ToString());
                OnStableBoard();
            }
    ...
    {
        Logic.EventCenter.Log(LOG_LEVEL.WARN, "Match3BoardGameLogic --> StableBoardLose");
        levelWon = false;
    ...
    {
        Logic.EventCenter.Log(LOG_LEVEL.WARN, "Match3BoardGameLogic --> StableBoardWin");
        levelWon = true;
    ...
    {
        Logic.EventCenter.Log(LOG_LEVEL.WARN, "Match3BoardGameLogic --> DestroyAllTriggerTiles-->");
    ...
    {
        Logic.EventCenter.Log(LOG_LEVEL.WARN, "Match3BoardGameLogic --> FreeFall-->");
        freeFalling = true;
    ...
    {
        Logic.EventCenter.Log(LOG_LEVEL.WARN, "Match3BoardGameLogic --> FreeFallFinished");
        OnStableBoard -= FreeFallFinished;
        freeFalling = false;
