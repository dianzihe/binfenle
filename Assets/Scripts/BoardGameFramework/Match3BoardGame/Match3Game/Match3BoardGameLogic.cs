...
//	public void BugTrapStableBoard(float lastWaitTime)
//	{	
//		// -1 stable, 0 - not stable, 1 should still wait
//		int state = -1;
...
//				for (int j = 0; j < boardData.NumColumns; ++j)
//				{
//					if (boardData[i, j] != null && boardData[i, j].Tile != null) 
//					{
//						if (boardData[i, j].Tile.IsMoving  || 
//							(boardData[i, j].Tile as NormalTile).IsTileSwitching || 
//							boardData[i, j].Tile.IsDestroying)
//						{
//							if (boardData[i, j].Tile.IsMoving) {
//								reasons.Add(1);
//							}
//							
//							if ((boardData[i, j].Tile as NormalTile).IsTileSwitching) {
//								reasons.Add(2);
//							}
//							
//							if (boardData[i, j].Tile.IsDestroying) {
//								reasons.Add(3);
//							}
//							
//							state = 0;
...
//							goto Finish;
//						}
//						else if (boardData[i, j].Tile is TimeBombTile || (boardData[i, j].Tile as NormalTile).IsFrozen())
//						{
//							if (boardData[i, j].Tile is TimeBombTile) {
//								reasons.Add(4);
//							}
//							
//							if ((boardData[i, j].Tile as NormalTile).IsFrozen()) {
//								reasons.Add(5);
//							}
//
//							state = 1;
...
//		if (state == 0) 
//		{
//			Debug.LogWarning("ALARM!!! Board is not stable! Last waitTime:" + lastWaitTime);
//			
//			string strReasons = "";
//			for(int i = 0; i < reasons.Count; i++) {
//				strReasons += " " + reasons[i];
//			}
//			
//			Debug.LogWarning("Reasons: " + strReasons);
//			
//			Debug.Break();
//		}
//		else if (state == 1)
//		{
//			Debug.LogWarning("ALARM!!! Board stable should still wait!!!");
//			Debug.Break();
//		}
//	}
